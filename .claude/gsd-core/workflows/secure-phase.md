...
```
Agent(
  prompt="Read /home/the_julian_alva/Documentos/Projects/othliani/.claude/agents/gsd-security-auditor.md for instructions.\n\n" +
...
**State B (create):**
1. Read template from `/home/the_julian_alva/Documentos/Projects/othliani/.claude/gsd-core/templates/SECURITY.md`
