...
@/home/the_julian_alva/Documentos/Projects/othliani/.claude/gsd-core/references/agent-contracts.md
@/home/the_julian_alva/Documentos/Projects/othliani/.claude/gsd-core/references/context-budget.md
@/home/the_julian_alva/Documentos/Projects/othliani/.claude/gsd-core/references/gates.md
</required_reading>
...
@/home/the_julian_alva/Documentos/Projects/othliani/.claude/gsd-core/references/execute-phase-response-language.md
...
- Executor agents omit extended deviation rule examples and checkpoint examples from inline prompt — load on-demand via @/home/the_julian_alva/Documentos/Projects/othliani/.claude/gsd-core/references/executor-examples.md
- Planner agents omit extended anti-pattern lists and specificity examples from inline prompt — load on-demand via @/home/the_julian_alva/Documentos/Projects/othliani/.claude/gsd-core/references/planner-antipatterns.md
...
```
Pure doc-only / config-only / test-only tasks return `is_behavior_adding=false` and are exempt. When the gate trips, Read `/home/the_julian_alva/Documentos/Projects/othliani/.claude/gsd-core/references/execute-mvp-tdd.md` for the exact halt report format.
</step>
...
2. For each plan (sequentially, ignoring wave grouping):
   ...
   c. **If "Execute":** Read and follow `/home/the_julian_alva/Documentos/Projects/othliani/.claude/gsd-core/workflows/execute-plan.md` **inline**
...
@/home/the_julian_alva/Documentos/Projects/othliani/.claude/gsd-core/references/execute-phase-wave-guard.md

@/home/the_julian_alva/Documentos/Projects/othliani/.claude/gsd-core/references/execute-phase-context-guard.md
   ...
   Agent(
    ...
    description="Execute plan {plan_number} of phase {phase_number}",
     ...
     prompt="
       ...
       - `/home/the_julian_alva/Documentos/Projects/othliani/.claude/gsd-core/references/checkpoints.md`
       - `/home/the_julian_alva/Documentos/Projects/othliani/.claude/gsd-core/references/tdd.md`
       - `/home/the_julian_alva/Documentos/Projects/othliani/.claude/gsd-core/references/worktree-path-safety.md`
       ${CONTEXT_WINDOW < 200000 ? '' : '- `/home/the_julian_alva/Documentos/Projects/othliani/.claude/gsd-core/references/executor-examples.md`'}
       </execution_context>
...
@/home/the_julian_alva/Documentos/Projects/othliani/.claude/gsd-core/references/execute-phase-quota-recovery.md

@/home/the_julian_alva/Documentos/Projects/othliani/.claude/gsd-core/references/execute-phase-between-wave-reset.md
...
**If gaps_found:**
@/home/the_julian_alva/Documentos/Projects/othliani/.claude/gsd-core/references/execute-phase-requirement-revert.md
```
...
@/home/the_julian_alva/Documentos/Projects/othliani/.claude/gsd-core/workflows/transition.md
</step>
