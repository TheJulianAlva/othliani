...
- **Global scope**: `/home/the_julian_alva/Documentos/Projects/othliani/.claude/notes/{YYYY-MM-DD}-{slug}.md` — fallback when no `.planning/`, or when `--global` flag is present
...
2. Ensure the notes directory exists (`.planning/notes/` or `/home/the_julian_alva/Documentos/Projects/othliani/.claude/notes/`)
...
2. Glob `/home/the_julian_alva/Documentos/Projects/othliani/.claude/notes/*.md` (if directory exists) — global notes
...
Global (/home/the_julian_alva/Documentos/Projects/othliani/.claude/notes/):
...
2. **No `.planning/`**: Falls back to global `/home/the_julian_alva/Documentos/Projects/othliani/.claude/notes/` — works in any directory
