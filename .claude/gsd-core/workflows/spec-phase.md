...
ones). Reference: @/home/the_julian_alva/Documentos/Projects/othliani/.claude/gsd-core/references/edge-probe.md.
...
# — NOT the consuming project's git root — falling back to git toplevel / /home/the_julian_alva/Documentos/Projects/othliani/.claude.
...
EDGE_PROBE_JS=$(for _c in \
  ...
  "/home/the_julian_alva/Documentos/Projects/othliani/.claude/gsd-core/bin/lib/edge-probe.cjs" \
  "/home/the_julian_alva/Documentos/Projects/othliani/.claude/bin/lib/edge-probe.cjs"; do
  [ -f "$_c" ] && { echo "$_c"; break; }
done)
...
requirement list). Reference: @/home/the_julian_alva/Documentos/Projects/othliani/.claude/gsd-core/references/prohibition-probe.md — the
...
Use the SPEC.md template from @/home/the_julian_alva/Documentos/Projects/othliani/.claude/gsd-core/templates/spec.md.
