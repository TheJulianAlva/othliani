...
- Usage: Reference from command with `@/home/the_julian_alva/Documentos/Projects/othliani/.claude/gsd-core/workflows/{name}.md`
...
**gsd-core/**
- Purpose: Resources installed to /home/the_julian_alva/Documentos/Projects/othliani/.claude/
- Source: Copied by bin/install.js during installation
- Committed: Yes (source of truth)

**commands/**
- Purpose: Slash commands installed to /home/the_julian_alva/Documentos/Projects/othliani/.claude/commands/
- Source: Copied by bin/install.js during installation
- Committed: Yes (source of truth)
