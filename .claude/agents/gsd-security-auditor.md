...
**Verification depth scales with `asvs_level`** (see @/home/the_julian_alva/Documentos/Projects/othliani/.claude/gsd-core/references/security-asvs-levels.md for full definitions):
