              ...
              Expanded(
                child: Column(
                  ...
                  children: [
                    ...
                    Text(
                      "ID: ${guia.id} • ${guia.rol} Senior • Desde 2021",
                      style: TextStyle(
                ...
                child: _buildRightCard("RENDIMIENTO OPERATIVO (ÚLTIMOS 12 VIAJES)", [
                  ...
                  SizedBox(
                    ...
                    child: Row(
                      ...
                      children: [
                        _buildMonthlyGroup("Diciembre", [
                          0.8,
                          0.9,
                          0.7,
                        ], Colors.green),
                        _buildMonthlyGroup("Enero", [
                          0.9,
                          1.0,
                          0.85,
                        ], Colors.green),
                        _buildMonthlyGroup("Febrero", [
                          0.7,
                          0.8,
                          0.6,
                        ], Colors.orange),
                        _buildMonthlyGroup("Marzo (Act.)", [
                          0.95,
                          0.9,
                          0.0,
                        ], Colors.green),
                  ...
                  const SizedBox(height: 32),
                  const Text(
                    "Últimas Evaluaciones Cualitativas",
                    style: TextStyle(fontWeight: FontWeight.bold, fontSize: 16),
                  ),
                  const SizedBox(height: 16),
                  _buildReviewItem(
                    "V-100 • Grutas de Tolantongo",
                    5.0,
                    "El guía Carlos mantuvo el control total del grupo. Comunicación excelente y solventó el retraso del desayuno muy bien. Sumamente recomendado para viajes VIP.",
                  ),
                  _buildReviewItem(
                    "V-082 • Chignahuapan",
                    4.0,
                    "El viaje estuvo bien, pero la llanta ponchada nos quitó mucho tiempo. El guía Carlos fue muy amable y nos mantuvo relajados.",
                  ),
                ]),
              ),
            ],
