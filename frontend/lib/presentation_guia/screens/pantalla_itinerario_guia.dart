...
class _ItineraryScreenGuiaState extends State<ItineraryScreenGuia> {
  ...
  void _showEditEventDialog({int? index}) {
    ...
    final timeController = TextEditingController(
      text: isEditing ? _events[index]['time'] : '',
    );
    final titleController = TextEditingController(
      text: isEditing ? _events[index]['title'] : '',
    );
    final descController = TextEditingController(
      text: isEditing ? _events[index]['description'] : '',
    );
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(title: const Text('Gestionar Itinerario')),
